...
import { getDateFromValue, getDaysInMonth, getMatrix, getNextDate, getOffsetDayInWeek, getPrevDate, IsCurrentDay, isDayInRage, isSelectedDay } from '../utils';
/**
...
var getDaysInPrevMonth = function getDaysInPrevMonth(date, offsetDayInWeek, value) {
  ...
  return Array.from(Array(offsetDayInWeek), function (_, i) {
    return {
      ...
      inRange: Array.isArray(value) ? isDayInRage(prevYear, prevMonth, daysInPrevMonth - (offsetDayInWeek - i) + 1, value) : false,
      date: {
