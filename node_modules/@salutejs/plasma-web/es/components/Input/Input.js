...
var applySizes = function applySizes() {
  return function (_ref) {
    ...
    return css(["height:", ";padding:", ";", " & + ", "{height:", ";padding:", " ", " ", " ", ";}&:focus + ", ",&:not(:placeholder-shown) + ", ",&:not(:placeholder-shown) + ", "{height:auto;padding-top:", ";}"], height, padding, $animatedHint === 'placeholder' && css(["&:placeholder-shown{padding-top:", ";padding-bottom:", ";}"], paddingY, paddingY), StyledHint, height, paddingY, paddingLeft, paddingY, paddingRight, StyledLabel, StyledLabel, StyledPlaceholder, inputLabelMarginTop);
  };
};
