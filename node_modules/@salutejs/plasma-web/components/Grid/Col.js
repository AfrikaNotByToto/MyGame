...
var Col = /*#__PURE__*/_styledComponents["default"].div.withConfig({
  ...
  return _utils.gridSizes.map(function (breakpoint) {
    ...
    return (0, _utils.mediaQuery)(breakpoint, deviceScale)((0, _styledComponents.css)(["", " ", ""], colSize && "width: ".concat(100 / _utils.gridColumns[breakpoint] * colSize, "%;"), colOffset && "margin-left: ".concat(100 / _utils.gridColumns[breakpoint] * colOffset, "%;")));
  });
});
