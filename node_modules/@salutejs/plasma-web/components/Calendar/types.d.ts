...
export declare type CalendarStateType = keyof typeof CalendarState;
...
export declare type CalendarValueType = Date | undefined | [Date | undefined, Date?];
...
export declare type CalendarRange<T> = Omit<T, 'value' | 'onChangeValue'> & {
    /**
     * Выбранное значение.
     */
    value: [Date, Date?];
...
export declare type KeyboardArrowKey = 'left' | 'right' | 'up' | 'down';
