...
var getDoubleCalendarSide = function getDoubleCalendarSide(currentIndexWeek) {
  if (currentIndexWeek >= 0 && currentIndexWeek < _utils.ROW_STEP) {
    return 'first';
  }

  if (currentIndexWeek >= _utils.ROW_STEP && currentIndexWeek < _utils.ROW_STEP * 2) {
    return 'second';
  }
...
var isVisible = function isVisible(refs, row, column) {
  var _refs$current, _refs$current$row;

  return (_refs$current = refs.current) === null || _refs$current === void 0 ? void 0 : (_refs$current$row = _refs$current[row]) === null || _refs$current$row === void 0 ? void 0 : _refs$current$row[column];
};
...
var hasDisabledArrowKey = function hasDisabledArrowKey(_ref3) {
  var _refs$current2, _refs$current2$previo, _refs$current2$previo2;
  ...
  var disabledArrowKey = (_refs$current2 = refs.current) === null || _refs$current2 === void 0 ? void 0 : (_refs$current2$previo = _refs$current2[previousRowIndex]) === null || _refs$current2$previo === void 0 ? void 0 : (_refs$current2$previo2 = _refs$current2$previo[previousColumnIndex]) === null || _refs$current2$previo2 === void 0 ? void 0 : _refs$current2$previo2.dataset.disabledArrowKey;
...
var hasDisabledMonths = function hasDisabledMonths(_ref4) {
  ...
  var item = _ref4.item,
      key = _ref4.key;
  return item !== null && item !== void 0 && (_item$dataset = item.dataset) !== null && _item$dataset !== void 0 && _item$dataset.disabledMonths ? item === null || item === void 0 ? void 0 : (_item$dataset2 = item.dataset) === null || _item$dataset2 === void 0 ? void 0 : _item$dataset2.disabledMonths.includes(key) : false;
};

var getNextCorrectPosition = function getNextCorrectPosition(_ref5) {
  var _refs$current3, _refs$current3$newRow;
  ...
  var item = (_refs$current3 = refs.current) === null || _refs$current3 === void 0 ? void 0 : (_refs$current3$newRow = _refs$current3[newRowIndex]) === null || _refs$current3$newRow === void 0 ? void 0 : _refs$current3$newRow[newColumnIndex];

  while (isAriaDisableItem(item) && newColumnIndex <= columnSize) {
    var _refs$current4, _refs$current4$newRow;
    ...
    item = (_refs$current4 = refs.current) === null || _refs$current4 === void 0 ? void 0 : (_refs$current4$newRow = _refs$current4[newRowIndex]) === null || _refs$current4$newRow === void 0 ? void 0 : _refs$current4$newRow[newColumnIndex];
...
var getPreviousCorrectPosition = function getPreviousCorrectPosition(_ref6) {
  var _refs$current5, _refs$current5$newRow;
  ...
  var item = (_refs$current5 = refs.current) === null || _refs$current5 === void 0 ? void 0 : (_refs$current5$newRow = _refs$current5[newRowIndex]) === null || _refs$current5$newRow === void 0 ? void 0 : _refs$current5$newRow[newColumnIndex];

  while (isAriaDisableItem(item) && newColumnIndex >= minColumnIndex) {
    var _refs$current6, _refs$current6$newRow;
    ...
    item = (_refs$current6 = refs.current) === null || _refs$current6 === void 0 ? void 0 : (_refs$current6$newRow = _refs$current6[newRowIndex]) === null || _refs$current6$newRow === void 0 ? void 0 : _refs$current6$newRow[newColumnIndex];
...
var getCorrectIndexes = function getCorrectIndexes(refs, _ref8, rowSize, columnSize, withShift, defaultState) {
  var _refs$current7, _refs$current7$newRow;
  ...
  if (newRowIndex === rowSize + 1) {
    newRowIndex = rowSize + 1 - _utils.ROW_STEP;
  ...
  if (isAriaDisableItem((_refs$current7 = refs.current) === null || _refs$current7 === void 0 ? void 0 : (_refs$current7$newRow = _refs$current7[newRowIndex]) === null || _refs$current7$newRow === void 0 ? void 0 : _refs$current7$newRow[newColumnIndex]) && withShift) {
...
var useKeyNavigation = function useKeyNavigation(_ref10) {
  ...
  var withShiftState = (0, _react.useRef)(false);
  var currentIndexes = (0, _react.useRef)([0, 0]);
  var outerRefs = (0, _react.useRef)(Array(rowSize + 1).fill(0).map(function () {
  ...
  (0, _react.useLayoutEffect)(function () {
    ...
    if (withShiftState.current) {
      ...
      var isFirst = isDouble && !isNext; // Определяем какую часть сдвоенного календаря взять
      ...
      if (!hasSomeEnabledDay && (isDisabledNextMonth || isDisabledPreviousMonth)) {
        ...
        inverseHandle();
        setSelectIndexes(currentIndexes.current); // Если индексы равны, значит мы остались на текущей дате по причине, того
  ...
  (0, _react.useLayoutEffect)(function () {
    var _outerRefs$current, _outerRefs$current$ro;

    var _selectIndexes = _slicedToArray(selectIndexes, 2),
        rowIndex = _selectIndexes[0],
        columnIndex = _selectIndexes[1];

    var item = outerRefs === null || outerRefs === void 0 ? void 0 : (_outerRefs$current = outerRefs.current) === null || _outerRefs$current === void 0 ? void 0 : (_outerRefs$current$ro = _outerRefs$current[rowIndex]) === null || _outerRefs$current$ro === void 0 ? void 0 : _outerRefs$current$ro[columnIndex];
  ...
  var onKeyDown = (0, _react.useCallback)(function (event) {
    ...
    switch (keyCode) {
          ...
          if (withShift) {
            var _getPreviousCorrectPo = getPreviousCorrectPosition(_objectSpread(_objectSpread({}, positionState), {}, {
              ...
              newColumnIndex: newColumnIndex
                ...
                columnIndex = _getPreviousCorrectPo2[1]; // Если индексы равны, значит мы остались на текущей дате по причине, того
            // что в следующем(-их)/предыдущем(-их) месяце нет доступных дат
          ...
          if (withShift) {
            ...
            var _getPreviousCorrectPo3 = getPreviousCorrectPosition(_objectSpread(_objectSpread({}, positionState), {}, {
              ...
              newColumnIndex: newColumnIndex
                ...
                _columnIndex = _getPreviousCorrectPo4[1]; // Если индексы равны, значит мы остались на текущей дате по причине, того
            // что в следующем(-их)/предыдущем(-их) месяце нет доступных дат
          ...
          if (withShift) {
            var _getNextCorrectPositi = getNextCorrectPosition(_objectSpread(_objectSpread({}, positionState), {}, {
              ...
              newColumnIndex: newColumnIndex
                ...
                _columnIndex2 = _getNextCorrectPositi2[1]; // Если индексы равны, значит мы остались на текущей дате по причине, того
            // что в следующем(-их)/предыдущем(-их) месяце нет доступных дат
          ...
          if (withShift) {
            ...
            var _getNextCorrectPositi3 = getNextCorrectPosition(_objectSpread(_objectSpread({}, positionState), {}, {
              ...
              newColumnIndex: newColumnIndex
                ...
                _columnIndex3 = _getNextCorrectPositi4[1]; // Если индексы равны, значит мы остались на текущей дате по причине, того
            // что в следующем(-их)/предыдущем(-их) месяце нет доступных дат
      ...
      case _types.Keys.space:
        {
          var _outerRefs$current2, _outerRefs$current2$n;

          (_outerRefs$current2 = outerRefs.current) === null || _outerRefs$current2 === void 0 ? void 0 : (_outerRefs$current2$n = _outerRefs$current2[newRowIndex]) === null || _outerRefs$current2$n === void 0 ? void 0 : _outerRefs$current2$n[newColumnIndex].click();
          break;
        }
