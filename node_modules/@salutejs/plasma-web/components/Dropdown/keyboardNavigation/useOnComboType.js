...
var useOnComboType = function useOnComboType(_ref) {
  ...
  return (0, _react.useCallback)(function (letter) {
    ...
    var searchIndex = (0, _utils.getIndexByLetter)(items.map(function (item) {
      return item.label;
    }), updatedSearchString, index + 1); // Если есть подходящая опция - переходим к ней
...
exports.useOnComboType = useOnComboType;