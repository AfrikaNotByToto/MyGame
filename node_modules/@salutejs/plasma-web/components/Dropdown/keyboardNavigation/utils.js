...
exports.getIndexByLetter = exports.filterOptions = exports.getUpdatedIndex = exports.getActionFromKey = exports.Keys = exports.Actions = void 0;
...
var getActionFromKey = function getActionFromKey(event, isOpen) {
  var altKey = event.altKey,
      ctrlKey = event.ctrlKey,
      metaKey = event.metaKey; // Все кнопки, которые открывают селект

  var key = event.key;
  var openKeys = [Keys.ArrowUp, Keys.ArrowDown, Keys.Enter, Keys.Space]; // Обработка открытия когда селект закрыт
...
var getUpdatedIndex = function getUpdatedIndex(action, index, items) {
...
exports.getUpdatedIndex = getUpdatedIndex;
...
exports.getIndexByLetter = getIndexByLetter;