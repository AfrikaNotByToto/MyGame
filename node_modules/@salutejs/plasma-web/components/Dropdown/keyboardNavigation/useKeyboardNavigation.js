...
exports.INITIAL_INDEX = INITIAL_INDEX;
...
var useKeyboardNavigation = function useKeyboardNavigation(_ref) {
  ...
  var onKeyDown = (0, _react.useCallback)(function (event) {
    ...
    if (action === _utils.Actions.Last || action === _utils.Actions.First || action === _utils.Actions.Next || action === _utils.Actions.Previous || action === _utils.Actions.PageUp || action === _utils.Actions.PageDown) {
      ...
      onIndexChange === null || onIndexChange === void 0 ? void 0 : onIndexChange((0, _utils.getUpdatedIndex)(action, index, items));
    } else if (action === _utils.Actions.Select) {
      event.stopPropagation();
      event.preventDefault();
      onItemSelect === null || onItemSelect === void 0 ? void 0 : onItemSelect(items[index], event);
