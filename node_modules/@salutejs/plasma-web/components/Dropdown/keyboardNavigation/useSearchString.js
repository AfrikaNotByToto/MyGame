...
var useSearchString = function useSearchString() {
  var _useState = (0, _react.useState)(''),
      _useState2 = _slicedToArray(_useState, 2),
      searchString = _useState2[0],
      setSearchString = _useState2[1];

  var searchTimeout = (0, _react.useRef)(null);
  var getSearchString = (0, _react.useCallback)(function (_char) {
    ...
    searchTimeout.current = window.setTimeout(function () {
      setSearchString('');
    }, 500); // Добавляем последнюю букву в поисковой строке

    setSearchString(function (prev) {
      return prev + _char;
    });
    return searchString + _char;
  }, [searchString]);
  var resetSearchString = (0, _react.useCallback)(function () {
    if (searchTimeout.current) {
      window.clearTimeout(searchTimeout.current);
    }
