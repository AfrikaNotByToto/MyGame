...
var DoneSvg = function DoneSvg(_ref) {
  var size = _ref.size,
      color = _ref.color;
...
var IndeterminateSvg = function IndeterminateSvg(_ref2) {
  var size = _ref2.size,
      color = _ref2.color;
  return /*#__PURE__*/_react["default"].createElement("svg", {
    width: "100%",
...
var StyledRoot = /*#__PURE__*/_styledComponents["default"].div.withConfig({
  componentId: "plasma-web__sc-ocexdy-0"
})(["display:inline-flex;"]); // TODO: https://github.com/salute-developers/plasma/issues/206


var Done = function Done(_ref3) {
  var size = _ref3.size,
      _ref3$color = _ref3.color,
      color = _ref3$color === void 0 ? _plasmaTokensB2b.white : _ref3$color,
      className = _ref3.className;
  return /*#__PURE__*/_react["default"].createElement(StyledRoot, {
    className: className
  }, /*#__PURE__*/_react["default"].createElement(DoneSvg, {
    color: color,
    size: sizesRem[size]
  }));
...
var Indeterminate = function Indeterminate(_ref4) {
  var size = _ref4.size,
      _ref4$color = _ref4.color,
      color = _ref4$color === void 0 ? _plasmaTokensB2b.white : _ref4$color,
      className = _ref4.className;
  return /*#__PURE__*/_react["default"].createElement(StyledRoot, {
    className: className
  }, /*#__PURE__*/_react["default"].createElement(IndeterminateSvg, {
    color: color,
    size: sizesRem[size]
  }));
};
